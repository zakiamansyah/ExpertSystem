...
<html>
<head>
  <title>Data Users - <?=$konfig['judul']?></title>
                ...
                <?php
                  ...
                  while ($row = mysql_fetch_array($sql)) {
                    echo '<tr>
                                <td>'.$no.'</td>
                                <td>'.$row['username'].'</td>
                                <td><button type="button" class="btn btn-warning" onclick=\'deletedata("'.$row['id'].'")\'>Delete</button></td>
                            </tr>
                            ';
                    $no++;
                  }
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="forminput">
              ...
              <div class="input-group">
                <input type="text" class="form-control" name="level" id="level" value="kepala" readonly>
              </div>
           </form>
        </div>
...
<script>
  ...
  showLoaderOnConfirm: true,
      ...
      $.ajax({
         type: "POST",
         url: "./ajax/virus/delete.php?id="+id
      }).done(function( data ) {
