      ...
      <a class="card card-banner card-blue-light">
        <div class="card-body">
          ...
          <div class="content">
            ...
            <div class="value"><?=$nama['nama'];?></div>
          </div>
        </div>
    </a>
  </div>
  <?php
  $sql = mysql_query("SELECT * FROM artikel limit 0,9");
  while ($row = mysql_fetch_array($sql)) {
  ?>
  <div class="col-md-4">
      <a href="lihat.php?program=<?=$row['id_artikel'];?>" class="card card-banner card-blue-light">
        <div class="card-body">
          <img src="assets/images/details-program/<?=$row['foto'];?>" width="360px" height="240px">
          <div class="content">
            <div class="value" style="font-size: 2em;margin-top: -25px;"><?=$row['judul'];?></div>
          </div>
        </div>
    </a>
  </div>
...
<br><br>
<div class="col-md-12">
<center><a href="detailsprogram.php" class="btn btn-info">Lihat Lainnya</a></center>
</div>
